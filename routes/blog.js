...
router.get('/posts/:id', async function (req, res, next) {
  ...
  try {
    ...
    // return next(error); // Forwards to default error handler
  }
...
router.post('/posts/:id/edit', async function (req, res) {
  ...
  const result = await db
    .getDb()
    .collection('posts')
    .updateOne({ _id: postId }, { $set: { title: req.body.title, summary: req.body.summary, body: req.body.content, date: new Date() } });
